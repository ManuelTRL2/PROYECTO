  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      var resultados = datos.filter(function (item) {
        ...
        return (folio_finanzas === '' || item_folio_finanzas.includes(folio_finanzas.normalize('NFD').replace(/[\u0300-\u036f]/g, ''))) &&
          (nombre === '' || item_nombre.includes(nombre.normalize('NFD').replace(/[\u0300-\u036f]/g, ''))) &&
          ...
          (concepto === '' || item_concepto.includes(concepto.normalize('NFD').replace(/[\u0300-\u036f]/g, ''))) &&
          (item_fecha >= fecha_inicio_timestamp && item_fecha <= fecha_fin_timestamp);
      });
